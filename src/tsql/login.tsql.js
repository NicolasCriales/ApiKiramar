export const tsqllogin = {
    ...
    verify: ` select  MTCLI.Nit, MTCLI.Nombre, mtcli.CodCiudad, mtcli.Ciudad, MTDEP.coddpto, MTDEP.departamento, mtcli.Direccion, mtcli.Celular, mtcli.Email,  mtcli.password
